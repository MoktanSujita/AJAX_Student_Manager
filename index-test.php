...
error_reporting(E_ALL);          //reports every single error, warning and notice 
ini_set('display_errors', 1);    //displays the error message on the web browser
?>
...
<head>
    ...
    <title>AJAX Student Manager</title>
...
<div class="bg-white p-8 rounded-2xl shadow-md w-96">
    ...
    <form method="post" action="add_student.php" class="space-y-4">
      ...
      <p class="mt-4 text-center text-sm">Don't have an account?</p>
